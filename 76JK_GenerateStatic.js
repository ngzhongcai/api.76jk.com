    ...
    uploadStatic(event, function(err, res) {
      ...
      createInvalidation(event, function(err, res) {
        ...
        downloadPhoto(event, function(err, res) {
          ...
          if(err) { context.fail("504::76JK_GENERATE_STATIC::DOWNLOAD_PHOTO::" + err.toString()); return; }
          ...
          compressPhoto(event, function(err, res) {
            ...
            if(err) { context.fail("505::76JK_GENERATE_STATIC::COMPRESS_PHOTO::" + err.toString()); return; }
            ...
            uploadPhoto(event, function(err, res) {
              ...
              if(err) { context.fail("506::76JK_GENERATE_STATIC::UPLOAD_PHOTO::" + err.toString()); return; }
