...
const processEmailViaSNS= function(event, callback) {
  ...
  "<div style='font-family:Arial,sans-serif;font-size:16px;line-height:1.5;color:#333'>" +
    ...
    "<p><a href='https://76jk.com/verify.html?userId=" + event.body.userId + "&token=" + event.body.token + "'>" +
    "https://76jk.com/verify.html?userId=" + event.body.userId + "&token=" + event.body.token + "</a></p>" +
